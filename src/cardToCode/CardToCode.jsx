...
import "./CardToCode.css";

const codeChars =
  "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789(){}[]<>;:,._-+=!@#$%^&*|\\/\"'`~?";

class CardStreamController {
  constructor(containerRef, cardLineRef) {
...
const CardToCode = () => {
  ...
  useEffect(() => {
    if (containerRef.current && cardLineRef.current) {
      ...
      cardStreamRef.current.setupEventListeners();
    }
    ...
    window.getScannerStats = () => {
      if (particleScannerRef.current) {
        return particleScannerRef.current.getStats();
      }
      return null;
    };
    ...
    return () => {
      if (cardStreamRef.current) {
        cardStreamRef.current.isAnimating = false;
      }
  ...
  return (
    <div className="card-to-code-container">
      <div className="container">
        ...
        <div className="card-stream" id="cardStream" ref={containerRef}>
